  ...
  const renderContent = () => {
    switch (stage) {
        ...
        return (
            <>
                <DialogBody>
                    ...
                    {file && <p className="text-sm font-medium mt-4">Selected file: {file.name}</p>}
      ...
      case Stage.Review:
        ...
        case Stage.Finished:
            return <DialogBody><div className="text-center"><p>Project imported successfully!</p></div></DialogBody>
    }
  };
